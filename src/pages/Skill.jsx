      ...
      <div className="w-full max-w-7xl mx-auto py-16">
        <div className="text-center mb-6 md:mb-8">
          <h1 className="font-instrument flex flex-wrap items-baseline justify-center gap-x-2 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-wide leading-tight md:flex-nowrap md:justify-center">
            ...
            <RotatingText
              texts={words}
              mainClassName="inline-flex flex-nowrap whitespace-nowrap sm:px-4 md:px-4 bg-indigo-50 text-black overflow-hidden py-0.5 sm:py-1 md:py-1 rounded-xl"
              staggerFrom="last"
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "-120%" }}
          ...
          <p className="font-bricolage text-neutral-300 text-base md:text-xl mt-6 mb-6 max-w-2xl mx-auto">
