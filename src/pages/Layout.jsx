...
export const Layout = ({ children }) => {
  return (
    <div className="w-full mx-auto relative min-h-screen overflow-hidden bg-[#4c64fe]">
      ...
      <div
        className="pointer-events-none absolute inset-0 flex items-center justify-center bg-[#4c64fe] [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] dark:bg-black"></div>
