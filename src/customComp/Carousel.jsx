    ...
    <div className="w-full flex flex-col justify-center pt-14 pb-2 overflow-visible">
      ...
      >
        ...
        {CARDS.map((card) => (
          <div
            key={card.id}
            className="relative w-[85vw] sm:w-[380px] md:w-[420px] h-[550px] md:h-[650px] shrink-0 rounded-[32px] overflow-hidden snap-start border-6 border-white dark:border-gray-200"
          >
            <video
              src={card.video}
              autoPlay
