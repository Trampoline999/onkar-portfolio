const Card = ({ video }) => {
  return (
    ...
    <div className="relative w-full max-w-[360px] aspect-video sm:h-[560px] sm:aspect-auto mx-auto rounded-3xl overflow-hidden shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] border-0 border-white/50 bg-gray-100 group lg:m-0">
